...
namespace BMEStokYonetim.Migrations
{
    ...
    [Migration("20251004130443_BMESon0005")]
    partial class BMESon0005
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMEStokYonetim.Data.Entities.AkaryakitCikis", b =>
                {
                    b.Property<int>("YakitCikisID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("YakitCikisID"));
                    ...
                    b.Property<int>("KaynakIstasyonID")
                        .HasColumnType("int");

                    b.Property<int>("MiktarLitre")
                        .HasColumnType("int");

                    b.Property<DateTime>("Tarih")
                        .HasColumnType("datetime2");

                    b.HasKey("YakitCikisID");

                    b.HasIndex("KaynakIstasyonID");

                    b.ToTable("AkaryakitCikislar");
                });

            modelBuilder.Entity("BMEStokYonetim.Data.Entities.AkaryakitGiris", b =>
                {
                    b.Property<int>("YakitGirisID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("YakitGirisID"));
                    ...
                    b.HasKey("YakitGirisID");

                    b.HasIndex("IstasyonID");

                    b.ToTable("AkaryakitGirisler");
                });

            modelBuilder.Entity("BMEStokYonetim.Data.Entities.AkaryakitIstasyon", b =>
                {
                    b.Property<int>("IstasyonID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AkaryakitIstasyonlar");
                });
            ...
            modelBuilder.Entity("BMEStokYonetim.Data.Entities.RequestItem", b =>
                {
                    ...
                    b.Property<string>("RequestItemNr")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BMEStokYonetim.Data.Entities.AkaryakitCikis", b =>
                {
                    b.HasOne("BMEStokYonetim.Data.Entities.AkaryakitIstasyon", "KaynakIstasyon")
                        .WithMany()
                        .HasForeignKey("KaynakIstasyonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KaynakIstasyon");
                });

            modelBuilder.Entity("BMEStokYonetim.Data.Entities.AkaryakitGiris", b =>
                {
                    b.HasOne("BMEStokYonetim.Data.Entities.AkaryakitIstasyon", "Istasyon")
                        .WithMany()
